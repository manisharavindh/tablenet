      ...
      <header className="bg-surface shadow-sm border-b border-slate-200/50 px-6 py-4 flex justify-between items-center z-10 relative">
        ...
        <div className="flex bg-slate-100 shadow-inset p-1.5 rounded-2xl overflow-x-auto snap-x">
          ...
          <button 
            ...
            className={`px-4 py-2.5 rounded-xl font-bold transition-all flex items-center gap-2 whitespace-nowrap snap-start ${activeTab === 'settings' ? 'bg-surface shadow-soft text-primary' : 'text-secondary hover:text-primary'}`}
          >
            <Settings size={18} />
            Settings
          </button>
