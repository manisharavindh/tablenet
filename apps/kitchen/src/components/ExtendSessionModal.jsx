  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end pointer-events-none md:items-center md:justify-center md:p-4">
      <div 
        ...
        onClick={onClose}
      ></div>
      <div className={`bg-white w-full max-w-md mx-auto md:rounded-3xl rounded-t-[2.5rem] shadow-2xl overflow-hidden flex flex-col relative z-10 pointer-events-auto ${isClosing ? 'animate-slideDown md:animate-fadeOut' : 'animate-slideUp md:animate-fadeIn'}`}>
        <div className="px-6 py-6 pb-28 md:pb-6">
